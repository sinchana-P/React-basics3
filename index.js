/*          INTRO
Here we create : Interactive web apps in React
...
*Example:
    *Bank website
    *Airbnb
    *Social-media Websites, Online games 
    *etc.
...
function Meme() {
    ...
    function getImage() {
        ...
        var memeImage = ob.data.memes[Math.round(Math.random() * 99)].url
...
//Note 1:
// .addEventListener("click", function() {})   --> In JS

// <div onclick="myFunction()" id="root"></div>   --> In HTML similar to React

//  <button onClick>Click me</button>
/* 
    Use Capital "C" for onClick
    bcz, We are accessing the DOM properties of the object being created here --->  <button onClick>Click me</button>
    Whatever attributes / properties we had in JSX are directly accessing equivalent properties JS.
    Camel-casing is standard throughout in our JS
       

*/

// NOTE 2:  Replaced < form > tag by < div > tag
/*
<div className="form">
                <input type="text" className="form--input" placeholder="Top text"/>
                <input type="text" className="form--input" placeholder="Bottom text"/>
