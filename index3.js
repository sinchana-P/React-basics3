...
function Header() {
 ...
 function Meme() {
    ...
    //  console.log(memeImage)
     ...
     let [allMemeImages, setAllMemeImages] = React.useState(ob)
     ...
     return (
         <main>
             <div className="form">
                 <input type="text" className="form--input left" placeholder="Top text"/>
                 <input type="text" className="form--input right" placeholder="Bottom text"/>
